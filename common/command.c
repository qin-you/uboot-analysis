...
{
	int len = &__u_boot_cmd_end - &__u_boot_cmd_start;  /*__u_boot_cmd_start in u-boot.lds*/
...
enum command_ret_t cmd_process(int flag, int argc, char * const argv[],
			       int *repeatable)
{
	enum command_ret_t rc = CMD_RET_SUCCESS;	/* 0: success */
	cmd_tbl_t *cmdtp;
...
#if defined(CONFIG_CMD_BOOTD)		/* not defined */
